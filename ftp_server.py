...
def cleanup_ftp(token):
    ...
    for path in domains['path']:
        ...
        # delete challenge file and .htaccess file
        log.info('Delete file: {}'.format(token))
        ftp.delete(token)
        log.info('Delete file: .htaccess')
        ftp.delete('.htaccess')
